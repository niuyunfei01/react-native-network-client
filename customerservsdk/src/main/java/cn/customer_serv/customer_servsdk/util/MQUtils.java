...
public class MQUtils {
    ...
    public static File getImageDir(Context context) {
        ...
        if (isExternalStorageWritable()) {
            ...
            imageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "customer_servSDK" + File.separator + appName);
            if (!imageDir.exists()) {
                imageDir.mkdirs();
            }
        } else {
    ...
    public static void putString(Context context, String key, String value) {
        SharedPreferences.Editor editor = context.getSharedPreferences("customer_servSDK", Context.MODE_PRIVATE).edit();
        editor.putString(key, value);
        editor.apply();
    }

    public static String getString(Context context, String key, String def) {
        return context.getSharedPreferences("customer_servSDK", Context.MODE_PRIVATE).getString(key, def);
    }
}
