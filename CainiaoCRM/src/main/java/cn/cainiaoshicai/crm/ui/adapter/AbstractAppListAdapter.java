...
import cn.cainiaoshicai.crm.support.asyncdrawable.IPictureWorker;
import cn.cainiaoshicai.crm.support.asyncdrawable.IWeiciyuanDrawable;
import cn.cainiaoshicai.crm.support.asyncdrawable.PictureBitmapDrawable;
...
import cn.cainiaoshicai.crm.support.lib.AnimationRect;
import cn.cainiaoshicai.crm.support.lib.ListViewMiddleMsgLoadingView;
import cn.cainiaoshicai.crm.support.lib.TimeLineAvatarImageView;
import cn.cainiaoshicai.crm.support.lib.TimeTextView;
import cn.cainiaoshicai.crm.support.utils.ThemeUtility;
import cn.cainiaoshicai.crm.support.utils.Utility;
import cn.cainiaoshicai.crm.support.utils.ViewUtility;
import cn.cainiaoshicai.crm.ui.basefragment.AbstractTimeLineFragment;
...
//                intent.putExtra("token", GlobalCtx.getInstance().getSpecialToken());
...
//                dialog.show(fragment.getFragmentManager(), "");
    ...
    protected void buildAvatar(ImageView view, int position, final UserBean user) {
        String image_url = user.getCover_image();
