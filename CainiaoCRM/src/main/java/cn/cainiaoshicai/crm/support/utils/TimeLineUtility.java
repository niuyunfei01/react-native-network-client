...
import cn.cainiaoshicai.crm.support.database.FilterDBTask;
import cn.cainiaoshicai.crm.support.debug.AppLogger;
import cn.cainiaoshicai.crm.support.helper.SettingUtility;
import cn.cainiaoshicai.crm.support.lib.LongClickableLinkMovementMethod;
import cn.cainiaoshicai.crm.support.lib.MyURLSpan;
import cn.cainiaoshicai.crm.support.lib.WeiboPatterns;
...
public class TimeLineUtility {
    ...
    public static boolean haveFilterWord(MessageBean content, List<String> keywordFilter
        ...
        if (content.getUser().getId().equals(GlobalCtx.getInstance().getCurrentAccountId())) {
            return false;
        }
