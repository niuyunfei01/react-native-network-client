...
public class JavaHttpUtility {
    ...
    private String handleError(HttpURLConnection urlConnection) throws ServiceException {
        ...
        try {
            ...
            if (Cts.ERR_INVALID_GRANT.equals(json.optString("error")) || errCode == ErrorCode.EXPIRED_TOKEN || errCode == ErrorCode.INVALID_TOKEN) {
...
//            AppLogger.d("result=" + strBuilder.toString());
    ...
    public String doGet(String urlStr, Map<String, String> param) throws ServiceException {
        ...
        try {
            ...
            AppLogger.d("request: " + url + ", from urlStr=" + urlStr + ", and param:" + param.toString());
            Proxy proxy = getProxy();
