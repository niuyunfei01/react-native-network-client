 ...
 * @since 1.0.1
 */
public class MappingJackson2HttpMessageConverter2 extends AbstractHttpMessageConverter<Object> {
    ...
    public MappingJackson2HttpMessageConverter2() {
        super(new MediaType("application", "json", DEFAULT_CHARSET),MediaType.TEXT_HTML);
    }
    ...
    protected Object readInternal(Class<?> clazz, HttpInputMessage inputMessage)
        ...
        JavaType javaType = getJavaType(clazz);
        String s = inputStream2String(inputMessage.getBody());
        Log.d("51daifan", "inputMessage:" + s);
        try {
            return this.objectMapper.readValue(new ByteArrayInputStream(s.getBytes()), javaType);
        }
