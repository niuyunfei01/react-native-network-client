...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void setStyleCustom(){
		CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(PushSetActivity.this, R.layout.customer_notitfication_layout, R.id.icon, R.id.fb_reported_at, R.id.text);
