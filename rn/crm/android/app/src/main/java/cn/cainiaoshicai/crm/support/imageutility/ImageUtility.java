...
public class ImageUtility {
    ...
    public static Bitmap getMiddlePictureInTimeLine(String url, int reqWidth, int reqHeight,
            FileDownloaderHttpHelper.DownloadListener downloadListener) throws ServiceException {
        try {
...
//            }
    ...
    public static Bitmap getRoundedCornerPic(String url, int reqWidth, int reqHeight,
            FileLocationMethod method) throws ServiceException {
...
//1        switch (SettingUtility.getUploadQuality()) {
//            case 1:
//                return picPath;
//            case 2:
