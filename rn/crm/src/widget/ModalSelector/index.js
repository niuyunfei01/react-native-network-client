...
const propTypes = {
  ...
  selectTextStyle: Text.propTypes.style,//选择元素的样式定义（仅在默认模式下可用）
  optionStyle: ViewPropTypes.style,//选项元素的样式定义
  optionTextStyle: Text.propTypes.style,//选项文本元素的样式定义
  ...
  sectionTextStyle: Text.propTypes.style,//选择文本元素的样式定义|section: true 的样式 - 已被当做头样式处理, 被选中请用defaultKey
  cancelStyle: ViewPropTypes.style,// 取消元素的样式定义
  cancelTextStyle: Text.propTypes.style,//取消文本元素的样式定义
