      ...
      <View style={{flex: 1}}>
        <View style={{
          ...
          <View style={{flexDirection: "row"}}>
            <TouchableOpacity style={this.state.activity === 'specifications_one' ? styles.tabActivity : styles.tab}
                              onPress={() => this.setState({activity: 'specifications_one'})}>
              <Text
                style={this.state.activity === 'specifications_one' ? styles.tabTextActivity : styles.tabText}>规格1</Text>
            </TouchableOpacity>
            <TouchableOpacity style={this.state.activity === 'specifications_two' ? styles.tabActivity : styles.tab}
                              onPress={() => this.setState({activity: 'specifications_two'})}>
              <Text
                style={this.state.activity === 'specifications_two' ? styles.tabTextActivity : styles.tabText}>规格2</Text>
            </TouchableOpacity>
            <TouchableOpacity style={this.state.activity === 'specifications_three' ? styles.tabActivity : styles.tab}
                              onPress={() => this.setState({activity: 'specifications_three'})}>
              <Text
                style={this.state.activity === 'specifications_three' ? styles.tabTextActivity : styles.tabText}>规格3</Text>
            </TouchableOpacity>
          </View>
        </View>
