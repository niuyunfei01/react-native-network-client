...
class GoodsDetailScene extends PureComponent {
  ...
  renderIcon = (status) => {
    if (status === Cts.STORE_PROD_ON_SALE) {
      return <Image style={[styles.icon_style]} source={require('../../../pubilc/img/Goods/shangjia.png')}/>;
      ...
      return <Image style={[styles.icon_style]} source={require('../../../pubilc/img/Goods/quehuo_.png')}/>;
    }
  };
