...
class GoodsDetailScene extends PureComponent {
  ...
  renderIcon = (status) => {
    if (status === Cts.STORE_PROD_ON_SALE) {
      return <Image style={[styles.icon_style]} source={require('../../public/img/goods/shangjia_.png')}/>;
      ...
      return <Image style={[styles.icon_style]} source={require('../../public/img/goods/quehuo_.png')}/>;
    }
  };
