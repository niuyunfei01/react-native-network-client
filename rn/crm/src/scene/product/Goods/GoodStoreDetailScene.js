...
class GoodStoreDetailScene extends PureComponent {
  ...
  renderIcon = (status) => {
    if (status === Cts.STORE_PROD_ON_SALE) {
      return <Image style={[styles.prodStatusIcon]} source={require('../../../pubilc/img/Goods/shangjia.png')}/>;
      ...
      return <Image style={[styles.prodStatusIcon]} source={require('../../../pubilc/img/Goods/quehuo_.png')}/>;
    }
  };
