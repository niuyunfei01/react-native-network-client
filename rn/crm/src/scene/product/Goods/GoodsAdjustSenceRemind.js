              ...
              {/*批量操作按钮*/}
              {
                batch ?
                  <TouchableWithoutFeedback onPress={() => this.handleSelectItem(i, dataSource[i], dataSource)}>
                    {
                      dataSource[i].batch ?
                        <Image style={styles.listItemBatchImage} source={require('../../../pubilc/img/Goods/xuanzhong_.png')}/>
                        :
                        <Image style={styles.listItemBatchImage} source={require('../../../pubilc/img/Goods/weixuanzhong_.png')}/>
                    }
                  </TouchableWithoutFeedback>
                  : null
              }
