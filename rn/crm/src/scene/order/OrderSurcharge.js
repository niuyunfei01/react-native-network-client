  ...
  renderAccordionHeader(item) {
    return (
      <View style={{
        ...
        <Text
          style={{color: colors.color333}}>{dayjs(item.created).format('YY-MM-DD')} ¥{tool.toFixed(item.total_fee)} </Text>
      ...
      items.push(
        ...
        >
          <View style={style.detailBox}>
            <Text style={{color: colors.color333}}>订单号：{listData[i].order_id} </Text>
            <WhiteSpace/>
            ...
            <WhiteSpace/>
            <Text
              style={{color: colors.color333}}>金&nbsp;&nbsp;&nbsp;&nbsp;额：{tool.toFixed(listData[i].total_fee)} </Text>
            <WhiteSpace/>
            <View style={style.remarkBox}>
              <Text style={{color: colors.color333}}>备&nbsp;&nbsp;&nbsp;&nbsp;注：</Text>
              <Text style={{flex: 1}}>
                {listData[i].remark}
              </Text>
            </View>
