    ...
    return (
      <View>
        <View style={styles.datePickerHead}>
          ...
          <Text style={styles.sureBtn}
                onPress={() => this.setState({dateValue: mealtime, mealTime: mealtime, showDateModal: false})}>确定</Text>
        </View>
