...
import { Dialog, Input, Toast,} from "../../weui/index";
          ...
          >
            ...
            <View style={{backgroundColor: colors.white,height: height, flex: 1, width: width}}>
              ...
              <View style={styles.btn}>
                ...
                {this.state.btns.add_tip == 1 && <TouchableOpacity onPress={() => this.setState({addTipMoney: true, addTipDialog: true})}><JbbText style={styles.btnText}>加小费</JbbText></TouchableOpacity>}
                {this.state.btns.stop_auto_ship == 1 && <TouchableOpacity onPress={() => {this.onStopSchedulingTo()}}><JbbText style={styles.btnText}>暂停调度</JbbText></TouchableOpacity>}
                {this.state.btns.cancel_ship == 1 && <TouchableOpacity onPress={() => {this.onConfirmCancel(this.state.btns.cancel_ship_id)}}><JbbText style={styles.btnText}>取消配送</JbbText></TouchableOpacity>}
                {this.state.btns.call_ship == 1 && <TouchableOpacity onPress={() => {this.onCallThirdShip(0)}}><JbbText style={styles .btnText}>追加配送</JbbText></TouchableOpacity>}
                {this.state.btns.if_reship == 1 && <TouchableOpacity onPress={() => {this.onCallThirdShip(1)}}><JbbText style={styles .btnText}>补送</JbbText></TouchableOpacity>}
              </View>
            </View>
          </Modal>
        </>
