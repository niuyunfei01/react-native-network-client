...
import {Clipboard, Linking, PixelRatio, Platform, TouchableWithoutFeedback, View} from "react-native";
      ...
      <TouchableWithoutFeedback onPress={() => {
        ...
        <View style={[Styles.columnStart, {
          ...
          <View style={[Styles.between, {paddingBottom: 8}]}>
            ...
            {Number(item.orderStatus) !== Cts.ORDER_STATUS_INVALID && <JbbText
              style={{color: colors.main_color, fontSize: 16, fontWeight: 'bold'}}>{item.expectTimeStrInList}</JbbText>}
