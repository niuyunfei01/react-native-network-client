...
class SearchExtStore extends React.Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    let dataSource = [];
    for (let key in ext_store) {
      let item = {...ext_store[key]};
  ...
  renderHeader() {
    return (<View style={styles.header}>
      ...
      <View><Text style={styles.headerTitle}>搜索外卖店铺</Text></View>
...
export default connect(mapStateToProps)(SearchExtStore);
