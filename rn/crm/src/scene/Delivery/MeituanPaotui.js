      ...
      <View style={{flexGrow: 1}}>
        <ScrollView
          ...
          <View style={{
            ...
            <Text style={{fontSize: 16, fontWeight: "bold"}}>什么是美团配送App</Text>
          ...
          <View style={{
            ...
            <Text style={{fontSize: 16, fontWeight: "bold"}}>如何在外送帮上使用</Text>
            <View style={{marginVertical: 8, marginHorizontal: 4}}>
              ...
              <View style={{flexDirection: 'row', marginHorizontal: 8, marginVertical: 4}}>
                ...
                <View style={{marginLeft: 6}}>
                  ...
                  <Text style={{fontSize: 12,}}>· 非美团外卖商家且无美团配送App账号的用户。</Text>
                  <TouchableOpacity
                    style={{marginVertical: 16}}
              ...
              <Text style={{fontSize: 14, marginTop: 3}}> 3.登录账号 </Text>
              ...
              <Text style={{fontSize: 14, marginTop: 3}}> 4.根据页面提示完成操作，即可授权外送帮 </Text>
              ...
              <Text style={{width: '100%', textAlign: 'center', fontSize: 12}}>*建议您选择永久授权 </Text>
              <Text style={{width: '100%', textAlign: 'center', fontSize: 12, marginTop: 3}}>防止您因忘记授权截止时间而不能发单</Text>
