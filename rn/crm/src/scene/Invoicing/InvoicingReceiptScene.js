    ...
    return (
      <ScrollView refreshControl={
        ...
        <View style={styles.select_box}>
          <ModalSelector cancelText={'取消'} data={storeLabels} keyExtractor={item => item.id}
                         labelExtractor={item => item.name} onChange={(option) => this.chooseStore(option)}>
          ...
          <ModalSelector cancelText={'取消'} data={supplierLabels} keyExtractor={item => item.id}
                         labelExtractor={item => item.name} onChange={(option) => this.chooseSupplier(option)}>
            <View style={styles.select_item}>
