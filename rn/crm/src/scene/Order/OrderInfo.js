                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    this.props.navigation.navigate(Config.ROUTE_ORDER_TRANSFER_THIRD, {
                                        ...
                                        storeId: this.state.order.store_id,
                                        selectedWay: [],
                                        onBack: (res) => {
                                            if (res && res.count > 0) {
                                                ToastShort('发配送成功')
                ...
                <If condition={is_service_mgr || !order.is_fn_price_controlled || order.is_fn_show_wm_price}>
                    ...
                    <View style={[{
                        ...
                        <View style={[styles.moneyLeft, {alignItems: 'center'}]}>
                            ...
                            <TouchableOpacity style={{marginLeft: 5}}><Icons
                                name='question-circle-o'/></TouchableOpacity>
                        </View>
                        <View style={{flex: 1}}/>
                        <Text
                            style={styles.moneyListNum}>{numeral(order.self_activity_fee / 100).format('0.00')} </Text>
                    </View>
                ...
                {order.additional_to_pay != '0' ?
                    <View style={[{
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                style={[{marginLeft: pxToDp(20), alignItems: 'center', justifyContent: 'center'}]}>
                    ...
                    <View style={{
                        ...
                        <View style={{width: '90%'}}>
                            <View style={{flexDirection: 'row'}}>
                                ...
                                <View style={{flex: 1}}></View>
                                <Text style={{
                                    color: log.lists[0].content_color,
                                    fontSize: 12
                                }}>{log.lists[0].content}  </Text>
                            </View>
                            <Text
                                style={{
                                ...
                                <For each="info" index="i" of={this.state.delivery_list}>
                                    <View key={i} style={{
                                        ...
                                        <View
                                            ...
                                            <Text
                                                style={{width: pxToDp(450)}}>{info.content} {info.driver_phone}  </Text>
        ...
        return <View key={idx} style={[{
            ...
            <View style={{flex: 3, flexDirection: 'row', alignItems: 'center'}}>
                <TouchableOpacity
                    onPress={() => {
                        let {product_id} = item
                        nav.navigate(Config.ROUTE_GOOD_STORE_DETAIL, {
                            pid: product_id,
                        ...
                        <If condition={!isServiceMgr && !fnShowWmPrice}>
                            ...
                            <If condition={fnPriceControlled}>
                                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                    <Text style={[styles.priceMode]}>保</Text>
                                    <Text
                                        style={{color: '#f44140'}}>{numeral(item.supply_price / 100).format('0.00')}</Text>
                                </View>
            ...
            return <View key={remind.id} style={{
                ...
                <View style={{
                    ...
                    {status === Cts.TASK_STATUS_WAITING &&
                        ...
                        >
                            <Text
                                style={{color: colors.white,}}>{type === Cts.TASK_TYPE_ORDER_CHANGE ? '标记为已处理' : '处理'}</Text>
                        </TouchableOpacity>
                    }
