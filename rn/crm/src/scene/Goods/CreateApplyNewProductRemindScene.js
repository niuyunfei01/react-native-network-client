...
class CreateApplyNewProductRemindScene extends PureComponent {
  static navigationOptions = ({navigation}) => {
    ...
    return {
      ...
      headerLeft: (<NavigationItem
        ...
        onPress={() => {
          navigation.navigate(Config.ROUTE_GOODS_APPLY_NEW_PRODUCT, {store_id: store_id})
        }}
      />)
    };
  };
  ...
  upLoad = async () => {
    let {vendor_id, store_id, goods_name, price_desc, slogan, upload_files} = this.state;
    let formData = {
      vendor_id,
      store_id,
      goods_name,
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateApplyNewProductRemindScene)