      ...
      <View style={{flex: 1}}>
        ...
        >
          <ScrollView style={{height: pxToDp(500)}}>
            ...
            />
            <Text style={{color: colors.color333}}>金额(元) </Text>
            <Input
              underlineColorAndroid="transparent"
              style={{
                borderWidth: pxToDp(1),
            ...
            />
            <Text style={{color: colors.color333}}>备注说明</Text>
            <Input
              underlineColorAndroid="transparent"
              style={{
                borderWidth: pxToDp(1),
    ...
    return (
      ...
      >
        <View style={[content.item, {position: "relative"}]}>
          <Text style={{color: colors.color333}}>{this.props.title} </Text>
          <View style={{flexDirection: "row", alignItems: "center"}}>
            <Text style={{color: colors.color333}}>{toFixed(this.props.money)} </Text>
            {this.props.toOperateDetail ? (
