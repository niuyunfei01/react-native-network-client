            ...
            <View style={styles.container}>
              ...
              <If condition={this.state.competition.StoreProduct && this.state.competition.StoreProduct.show}>
                <View style={{
                  ...
                  <Text style={{
                    color: '#999999',
                    fontSize: pxToDp(30)
                  }}>当前在售商品{this.state.competition.StoreProduct.score}个</Text>
                </View></If>
                ...
                <TouchableOpacity style={{
                  ...
                  <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                    ...
                    <View style={{flexDirection: "row", alignItems: "center"}}>
                      <Text style={{
                        color: '#999999',
                        fontSize: pxToDp(30)
                      }}>当前调价{this.state.competition.BusinessCircleChg.cnt.total}个</Text>
                  ...
                  <View style={{
                    ...
                    <View style={{flexDirection: "row", alignItems: "center"}}>
                      ...
                      }}>共计{this.state.competition.BusinessCircleChg.cnt.up}个</Text>
                    </View>
                    <View style={{flexDirection: "row", alignItems: "center"}}>
                      ...
                      <Text style={{
                        fontSize: pxToDp(26),
                        marginLeft: pxToDp(30)
                      }}>共计{this.state.competition.BusinessCircleChg.cnt.down}个</Text>
                    </View>
                  </View>
                </TouchableOpacity></If>
              ...
              <If condition={this.state.competition.PriceScore && this.state.competition.PriceScore.show == 1}>
                <TouchableOpacity style={{
                  ...
                  <View style={{flexDirection: "row", alignItems: "center"}}>
                    <Text
                        style={{color: '#999999', fontSize: pxToDp(30)}}>{this.state.competition.PriceScore.tip}</Text>
                    <Entypo name="chevron-right" style={styles.right_icon}/>
                  </View>
                </TouchableOpacity></If>
              ...
              <If condition={this.state.competition.StoreScore && this.state.competition.StoreScore.show}>
                <TouchableOpacity style={{
                  ...
                  paddingVertical: '1%'
                                  ...
                                  onPress={() => this.navigate(Config.ROUTE_STORE_RATE, {score: this.state.competition.StoreScore.score})}>
                  <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                  ...
                  }}>本月累计评价{this.state.competition.StoreComment.comments.total}个；差评{this.state.competition.StoreComment.comments.bad}个，好评{this.state.competition.StoreComment.comments.good}个</Text>
                </TouchableOpacity></If>
              ...
              <If condition={this.state.competition.HotSaleProds && this.state.competition.HotSaleProds.show}>
                <TouchableOpacity style={{
                  ...
                  marginLeft: '1%',
                  paddingVertical: '3%'
                }} onPress={() => this.navigate(Config.ROUTE_GOODS_ANALYSIS)}>
                  ...
                  <View style={{flexDirection: "row", alignItems: "center"}}>
                    <Text
                        style={{
                          color: '#999999',
                          fontSize: pxToDp(30)
                        }}>{this.state.competition.HotSaleProds.tip}</Text>
                    <Entypo name="chevron-right" style={styles.right_icon}/>
                  </View>
                </TouchableOpacity></If>
              ...
              <TouchableOpacity style={{
                ...
                paddingVertical: '3%',
                marginVertical: '2%'
              }} onPress={() => this.navigate(Config.ROUTE_STORE_RULE, {cnt: this.state.competition.StoreComment.cnt})}>
              ...
              <TouchableOpacity style={{
                ...
                marginLeft: '1%',
                paddingVertical: '3%'
              }} onPress={() => this.navigate(Config.ROUTE_GOODS_MARKET_EXAMINE)}>
