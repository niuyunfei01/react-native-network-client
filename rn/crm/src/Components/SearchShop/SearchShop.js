...
class SearchShop extends Component {
    ...
    choseItem = () => {
        return <View style={{display: 'flex', flexDirection: 'row',position:'absolute',top:pxToDp(0),zIndex:999, backgroundColor: colors.colorEEE}}>
        ...
        return (
            this.state.isMap ? (
                <View style={{
                    ...
                    {this.choseItem()}
                    <ShopInMap name={this.state.shopmsg}/>
                </View>
