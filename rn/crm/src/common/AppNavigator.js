...
import Grouptakeaway from "../Components/Grouptakeaway"
    ...
    return (
        <NavigationContainer ref={navigationRef}
            ...
            <Stack.Navigator
                ...
                <Stack.Screen name={Config.ROUTE_TAKE_WAY} options={{headerTitle: '绑定美团外卖'}}
                              component={Grouptakeaway}
                              initialParams={Grouptakeaway}/>
